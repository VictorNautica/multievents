#' List object containing decathlon data
#'
#' A list object containing tibbles of decathlete names, International Olympic Committee (IOC) country codes, final ranking and event scores for decathletes who completed the decathlon at the Olympics, IAAF World Championships, and Götzis Hypomeeting events from 2000 onwards.
#'
